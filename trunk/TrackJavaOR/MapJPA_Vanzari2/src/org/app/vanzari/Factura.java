...
public class Factura implements Serializable {
	...
	public Factura(long idFact, String nrFact, String client, Date dataFact,
			String obs) {
		super();
		this.idFact = idFact;
		this.nrFact = nrFact;
	...
	public void addLinieFactura(LinieFactura linie){
		this.liniiFacturi.add(linie);
		linie.setFactura(this);
	}
	
	public void removeLinieFactura(LinieFactura linie){
		if (this.liniiFacturi.contains(linie)){
			this.liniiFacturi.remove(linie);
			linie.setFactura(null);			
		}
	}
