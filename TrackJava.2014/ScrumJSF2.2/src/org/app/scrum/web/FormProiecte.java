...
public class FormProiecte {
	...
	public void previousProiect(ActionEvent actionEvent){
		Integer idxCurent = this.proiecte.indexOf(this.proiect);
		if (idxCurent > 0)
			this.proiect = this.proiecte.get(idxCurent -1);
	}
	public void nextProiect(ActionEvent actionEvent){
		Integer idxCurent = this.proiecte.indexOf(this.proiect);
...
/*
					<p:ajax
						render="proiect_numeProiect proiect_nrProiect proiect_dataStart"></p:ajax>
